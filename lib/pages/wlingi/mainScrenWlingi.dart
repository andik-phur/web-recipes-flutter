...
import 'detaiScreenWlingi.dart';

import '../../models/masakan_uenakk.dart';
import 'package:lottie/lottie.dart';

class MainScreenWlingi extends StatelessWidget {
  @override
        ...
        return InkWell(
          ...
          child: Card(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(flex: 1, child: Image.network(place.imageMasakanWLG)),
                Expanded(
                  flex: 2,
                  child: Padding(
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(context,
                      ...
                      return DetailScreenWlingi(place: place);
                    }));
                  },
                  child: Stack(
                    children: [
                      ClipRRect(
                        ...
                        child: Expanded(
                          child: Container(
                              ...
                              child: Image(
                                fit: BoxFit.cover,
                                image: NetworkImage(place.imageMasakanWLG),
                              )),
                        ),
                      ),
                      SizedBox(height: 20),
